...
## One-liner
Generate a Product Requirements Document with Ideal State Criteria, open questions, and ISC-proof verify methods.
...
- PRDs >7d without /implement-prd kickoff are likely stale (unstated blockers emerged); surface as backlog signal.
