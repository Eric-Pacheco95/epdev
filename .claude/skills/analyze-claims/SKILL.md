...
## One-liner
Audit an argument's claims against its own cited sources, map evidence gaps, and rate overall support quality.
...
- Signal {YYYY-MM-DD}_analyze-claims-{slug}.md: >= 3 unsupported/weak claims; rating 7+/novel-fallacy-or-deception, 4-6/routine; skip if nothing surprising.
