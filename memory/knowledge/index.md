...
| 2026-03-27 | Jarvis Brain Map — AI-Native Graph PM Tool | React Flow confirmed (35.6K stars, 4.59M installs, MIT); Contextual Zoom is built-in; no tool combines git-native + semantic nodes + AI co-pilot + write-back | `ai-infra/2026-03-27_jarvis-brain-map-graph-pm.md` |
